...
@permission_required('relationship_app.can_add_custom_book', raise_exception=True)
...
@permission_required('relationship_app.can_change_custom_book', raise_exception=True)
...
@permission_required('relationship_app.can_delete_custom_book', raise_exception=True)
